        ...
        <section id="opening" className="section opening-section">
          ...
          <div className="section-inner opening-grid">
            ...
            <article className="book-page">
              ...
              <a className="button excerpt-button" href="#chapter">Read the full chapter</a>
            </article>
          </div>
        </section>
        ...
        <section id="author" className="section author-section">
          ...
          <div className="section-inner">
            ...
            <div className="author-story">
              <div className="author-prose">
                <p>Corporate work gave me a more sophisticated vocabulary for the same disappearance. A person became a user, a subscriber, an account, a case, a claim, a conversion, a churn risk. Even the good words, patient, passenger, member, the ones with a person still inside them, hollowed out once the system began measuring them instead of seeing them. Each label could be accurate and still incomplete. The problem began when the system forgot the difference.</p>
